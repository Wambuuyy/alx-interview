...
def rotate_2d_matrix(matrix):
    ...
    1. **Transpose the Matrix**:
       ...
       - This operation is done only for elements
       above the diagonal (where i < j)
         to avoid redundant swaps.
       - The diagonal elements remain unchanged, as swapping them
       would not change their positions.

    2. **Reverse Each Row**:
       - After transposing the matrix, we reverse the order
